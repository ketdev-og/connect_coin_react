...
const Footer = () => {
  return (
    <>
      ...
      <StyledBottom className="px-8 py-8 flex flex-col items-center justify-center">
        <p className="my-4">© 2012 - 2022 ConnectCoins Oy. All rights reserved.</p>
        <div className="my-4">
        ...
        <div  className="flex my-2">
          <a href="" className="ft_icons"><BsFacebook className="text-3xl "/></a>
          <a href="" className="ft_icons"><FaTwitterSquare className="text-3xl mx-8"/></a>
          <a href="" className="ft_icons"><FaInstagramSquare className="text-3xl"/></a>
        </div>
      </StyledBottom>
    </>
  );
